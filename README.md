...
flowchart TD
    ...
    x["Input 'x': n bits</br>---</br>Результат: x₁ x₂ ... xₙ"]
    nx["Отрицание входов 'nx': n bits</br>---</br>Результат: nx₁ nx₂ ... nxₙ"]
    l["Литералы 'l': 2n bits</br>---</br>Результат: l₁ l₂ ... l₂ₙ"]
    
    %% Блоки автоматов и маски
    a["Автоматы 'a': 2m × 2n signed integers</br>---</br>Результат:</br>e₁,₁  e₁,₂  ...  e₁,₂ₙ</br>e₂,₁  e₂,₂  ...  e₂,₂ₙ</br>...   ...   ...  ...</br>eₘ,₁  eₘ,₂  ...  eₘ,₂ₙ</br>eₘ₊₁,₁ eₘ₊₁,₂ ... eₘ₊₁,₂ₙ</br>eₘ₊₂,₁ eₘ₊₂,₂ ... eₘ₊₂,₂ₙ</br>...    ...   ...  ...</br>e₂ₘ,₁  e₂ₘ,₂  ...  e₂ₘ,₂ₙ"]
    
    e["Маска исключения 'e': 2m × 2n bits</br>---</br>Результат:</br>e₁,₁  e₁,₂  ...  e₁,₂ₙ</br>e₂,₁  e₂,₂  ...  e₂,₂ₙ</br>...   ...   ...  ...</br>eₘ,₁  eₘ,₂  ...  eₘ,₂ₙ</br>eₘ₊₁,₁ eₘ₊₁,₂ ... eₘ₊₁,₂ₙ</br>eₘ₊₂,₁ eₘ₊₂,₂ ... eₘ₊₂,₂ₙ</br>...    ...   ...  ...</br>e₂ₘ,₁  e₂ₘ,₂  ...  e₂ₘ,₂ₙ"]
    
    %% Блоки голосования и результатов
    t["Голоса команды 't': 2m bits</br>---</br>Результат:</br>t₁ t₂ ... tₘ tₘ₊₁ tₘ₊₂ ... t₂ₘ"]
    
    pt["Суммирование голосов</br>---</br>Результат:</br>pt (позитивные)</br>nt (негативные)"]
    
    v["Финальное голосование 'v'</br>---</br>Результат: v"]
    
    y["Предсказание 'y_pred'</br>---</br>Результат: y_pred"]
    ...
    t -- "t_j = and(e_j,i ∨ l_i)</br>(e₁,₁ ∧ l₁) ∨ (e₁,₂ ∧ l₂) ∨ ... ∨ (e₁,₂ₙ ∧ l₂ₙ)</br>..." --> pt
    pt -- "pt = sum(t_1..t_m)</br>nt = sum(t_m+1..t_2m)" --> v
    v -- "v = pt - nt" --> y
